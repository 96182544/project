  ...
  return (
    ...
    <div className="flex gap-5 justify-between items-start w-full max-md:flex-wrap max-md:max-w-full">
      <div className="flex flex-col text-6xl font-black text-blue-900 uppercase whitespace-nowrap leading-[70.4px] max-md:text-4xl">
        <div className="self-end ml-24 max-md:text-4xl">blog</div>
        <div className="shrink-0 mt-7 bg-blue-900 h-[5px]" />
      </div>
      <div className="flex gap-5 justify-between">
        <Image
          loading="lazy"
          src={image1}
          className="shrink-0 aspect-[0.47] w-[42px]"
        />
        <Image
          loading="lazy"
          srcSet="..."
          className="shrink-0 max-w-full aspect-[1.16] w-[105px]"
        />
      </div>
    </div>
