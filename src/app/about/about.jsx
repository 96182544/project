...
export default function About() {
  return (
    <div className="flex flex-col items-start px-5">
      <div className="ml-24 mt-20 text-6xl font-black text-blue-900 uppercase leading-[70.4px] max-md:max-w-full max-md:text-4xl">
        Pourquoi nous ?
      </div>
      <div className="shrink-0 mt-7 max-w-full bg-blue-900 h-[5px] w-[534px]" />
      <div className="flex flex-col self-center mt-7 w-full max-w-[1612px] max-md:max-w-full">
          ...
          <div className="flex gap-20 max-md:flex-col max-md:gap-0">
            <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow items-center mt-7 text-blue-900 max-md:mt-10 max-md:max-w-full">
                ...
                <div className="mt-10 text-2xl font-medium leading-10 text-center capitalize max-md:max-w-full">
            ...
            <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow items-center text-blue-900 max-md:mt-10 max-md:max-w-full">
                ...
                <div className="mt-8 text-2xl font-medium leading-10 text-center capitalize max-md:max-w-full">
        ...
        <div className="flex gap-5 justify-between mt-11 max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
          <div className="shrink-0 w-4/12 ml-24 bg-yellow-400 h-[5px] " />
          <div className="shrink-0 w-2/6 mr-24 bg-yellow-400 h-[5px] " />
        </div>
          ...
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow text-blue-900 max-md:mt-10 max-md:max-w-full">
                ...
                />
                <div className="mx-14 mt-7 text-4xl font-bold leading-10 uppercase max-md:mr-2.5 max-md:max-w-full">
        ...
        <div className="flex gap-5 justify-between mt-11 max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
          <div className="shrink-0 max-w-full bg-yellow-400 h-[5px] w-[777px]" />
          <div className="shrink-0 max-w-full bg-yellow-400 h-[5px] w-[777px]" />
        </div>
      </div>
    </div>
